...
@section('content')
    ...
    <div class="container">
        <div class="row  ">
            <div class="col-md-12">
                <form action="{{ route('contact') }}"class="mt-5 mx-2" method="POST">
                    @csrf
                    ...
                    <div class="form-group mb-2">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="tel" class="form-control" id="phone" placeholder="Enter phone number"
                                name="phone"><br>
                            @error('phone')<span class="alert alert-danger m-2">{{ $message }}</span>@enderror

                            </div>
                            <div class="form-group mb-2">
                                <label for="address"><b>Address:</b></label>
                                <input type="address" class="form-control" placeholder="Enter address" name="address"><br>
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <textarea class="form-control" id="message" rows="3" name="message"></textarea><br>
